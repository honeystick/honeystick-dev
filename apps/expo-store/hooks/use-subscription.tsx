 ...
 *
 * The native counterpart of the web store's `use-subscription`, and it exists
 * for a sharper version of the same reason. On the web the plan id has to
 * survive leaving the origin for PayFast; here it has to survive the payment
 * happening in a *different application* - the system browser - which the app
 * cannot see into and is not guaranteed to be running behind.
 *
