 ...
 *
 * Kept as one object rather than scattered through StyleSheets so the three
 * stores can be held side by side and seen to be the same shop. React Native has
 * no cascade to inherit these from, so they are passed by hand - which is why
